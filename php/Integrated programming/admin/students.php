                ...
                <form action="delete_student.php" method="post">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                        ...
                        <tbody>
                            ...
                            $query = mysqli_query($conn, "SELECT student.*, class.class_name FROM student LEFT JOIN class ON student.class_id = class.class_id ORDER BY student.student_id DESC LIMIT $start, $limit");
