                    ...
                    <div class="control-group">
                        <div class="controls">
                            <button name="save" class="btn btn-info"><ion-icon
                                    name="add-circle-outline"></ion-icon></i></button>
                ...
                <form action="delete_student.php" method="post">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                        ...
                        <tbody>
                            ...
                            $query = mysqli_query($conn, "SELECT * from student LEFT JOIN class ON student.class_id = class.class_id where status = 'Unregistered' ORDER BY student.student_id DESC LIMIT $start, $limit");
